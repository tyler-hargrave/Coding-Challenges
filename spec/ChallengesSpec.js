...
describe("15-mergeObjects", function () {
 ...
 it("merges props from left to right", function () {
  expect(mergeObjects({ a: 1, b: 2, c: 3 }, { d: 4 }, { b: 22, d: 44 })).toEqual({
   a: 1,
   b: 22,
   c: 3,
   d: 44,
...
describe("27-countTheBits", function () {
 ...
 it("returns the correct number of bits", function () {
  ...
  //Error in code...13 is 4
  expect(countTheBits(13)).toBe(4);
  //Error in code...256 is not 1 it is 9
  expect(countTheBits(256)).toBe(9);
